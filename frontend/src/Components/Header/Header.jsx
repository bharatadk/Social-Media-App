...
export const Header = () => {
    ...
    return (
        <SideNav expanded={true}         onToggle={(expanded) => {            this.setState({ expanded });
        }}   style={{ margin:"0px",padding:"0px",    backgroundColor: "white",   width: "20px"}} 
    onSelect={(selected) => {
        navigate("/"+selected) 
    }}
>
    ...
    <SideNav.Nav defaultSelected="home">
        ...
        <NavItem eventKey=""  >
            ...
            <NavText style={{color:"black",marginLeft:"20px"}}>
               <h1 style={{color:"black",fontSize:"30px"}} > Social Media </h1>
            </NavText>
        </NavItem>
